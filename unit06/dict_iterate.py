...
# 3. Before we get started, let's adjust a few things. First off, Jeff just read a new book called "The Martian" and loved it.
#    With just one line of code, change Jeff's favorite book to "The Martian"
...
# 7. Now let's start iterating. For each person in the dictionary, print out a statement that says "___'s favorite book is ____"
#    and fill in the blanks with that person's name and that person's favorite book.
